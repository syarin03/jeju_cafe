...
//int connect_server()
//{
//    // 1. QTcpSocket 인스턴스 생성

//    // 2. 서버에 연결
//    socket.connectToHost("10.10.21.107", 9001);
...
{
//    this->socket.connectToHost("10.10.21.107", 9001);
//    this->socket.connectToHost("10.10.21.116", 9001);
